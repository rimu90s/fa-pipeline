...
function humanize(raw: string) {
  ...
  if (msg.includes("rate limit") || msg.includes("too many")) return "Terlalu banyak permintaan. Coba lagi beberapa saat.";
    ...
    <div className="relative isolate min-h-dvh bg-[color:var(--bg)]">
      ...
      <div className="relative z-10 mx-auto grid min-h-dvh w-full max-w-6xl grid-cols-1 items-center gap-10 px-6 py-10 md:grid-cols-2">
        <div className="hidden md:block animate-[authIn_.55s_ease-out_both]">
          ...
          <h1 className="mt-4 text-4xl font-semibold tracking-tight text-[color:var(--fg)]">Reset your password</h1>
            ...
            <div className="relative rounded-3xl p-[1px] bg-[linear-gradient(135deg,rgba(43,89,255,0.38),rgba(139,92,246,0.26),rgba(17,20,57,0.10))] shadow-[0_35px_110px_rgba(17,20,57,0.18)]">
              <div className="relative overflow-hidden rounded-3xl bg-white/80 backdrop-blur-md p-7 ring-1 ring-[rgba(17,20,57,0.08)]">
                ...
                <div className="relative">
                  <h2 className="text-xl font-semibold tracking-tight text-[color:var(--fg)]">Forgot password</h2>
                  ...
                  <form onSubmit={onSubmit} className="mt-6 space-y-4" noValidate>
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-[color:var(--fg)]" htmlFor="fp-email">Email</label>
                      <input
                        ref={emailRef}
                        id="fp-email"
                        className={cx(
                        ...
                        value={email}
                        onChange={(e) => { setErr(null); setOk(null); setEmail(e.target.value); }}
                        onBlur={() => setTouched(true)}
                        autoComplete="email"
                        inputMode="email"
                        placeholder="name@company.com"
                        aria-invalid={!!eErr}
                        aria-describedby={eErr ? "fp-email-help" : undefined}
                      />
                      <p id="fp-email-help" className={cx("text-xs", eErr ? "text-red-600" : "text-[color:rgba(17,20,57,0.58)]")}>
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <Link href="/login" className="text-[color:var(--fg)] underline decoration-[rgba(17,20,57,0.25)] underline-offset-4 hover:opacity-90 hover:decoration-[rgba(17,20,57,0.45)]">
                        Back to login
                      </Link>
                    </div>
